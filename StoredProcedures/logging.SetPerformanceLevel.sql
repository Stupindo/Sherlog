...
CREATE PROCEDURE logging.SetPerformanceLevel
...
BEGIN
 SET NOCOUNT ON
 --TODO::eliminate code duplication with similar sproc logging.SetLevel
 DECLARE @settingName nvarchar(256) = N'logging.performance' + case when isnull(@LoggerName,N'') = N'' THEN N'' ELSE N'.' END + isnull(@LoggerName,N'');
...
GRANT EXEC ON logging.SetPerformanceLevel TO PUBLIC;
GO
